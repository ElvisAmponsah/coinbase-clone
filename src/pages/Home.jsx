    ...
    const features = [
        {
            ...
            description: 'We store the vast majority of digital assets in secure offline storage. Cryptocurrency stored on our platform is covered by our insurance policy.',
        },
        {
            icon: HiDeviceMobile,
            title: 'Mobile apps',
            description: 'Stay on top of the markets with the Coinbase app for Android or iOS. Trade crypto anytime, anywhere.',
        },
        {
            icon: HiRefresh,
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="max-w-xl">
                            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-cb-dark leading-tight mb-6">
                                Jump start your{' '}
                                <span className="text-cb-blue">crypto portfolio</span>
                            </h1>
                                    ...
                                    <div className="w-full h-full bg-white rounded-[2.3rem] p-6 flex flex-col">
                                            ...
                                            <svg viewBox="0 0 300 150" className="w-full h-full">
                                                <defs>
                                                    <linearGradient id="heroChartGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                                                        <stop offset="0%" style={{ stopColor: '#0052FF', stopOpacity: 0.15 }} />
                                                        <stop offset="100%" style={{ stopColor: '#0052FF', stopOpacity: 0 }} />
                                                    </linearGradient>
                                                </defs>
                                                <polygon
                                                    fill="url(#heroChartGrad)"
                                                    points="0,120 30,110 60,95 90,100 120,80 150,70 180,85 210,50 240,55 270,30 300,25 300,150 0,150"
                                                />
                                                <polyline
                                                    fill="none"
                                                    stroke="#0052FF"
                                                    strokeWidth="2.5"
                                                    strokeLinecap="round"
                                                    points="0,120 30,110 60,95 90,100 120,80 150,70 180,85 210,50 240,55 270,30 300,25"
                                                />
                                            </svg>
                                        </div>
                                        ...
                                        <div className="flex justify-around pt-3 border-t border-cb-gray-200">
                                            <div className="text-center">
                                                <div className="w-6 h-6 bg-cb-blue rounded-full mx-auto mb-1"></div>
                                                <span className="text-[10px] text-cb-gray-500">Home</span>
                                            </div>
                                            <div className="text-center">
                                                <div className="w-6 h-6 bg-cb-gray-200 rounded-full mx-auto mb-1"></div>
                                                <span className="text-[10px] text-cb-gray-500">Trade</span>
                                            </div>
                                            <div className="text-center">
                                                <div className="w-6 h-6 bg-cb-gray-200 rounded-full mx-auto mb-1"></div>
                                                <span className="text-[10px] text-cb-gray-500">Pay</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="bg-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <Button variant="outline" size="sm" to="/explore">
                            See all assets
                            <HiArrowRight className="ml-2" />
                        </Button>
                    </div>
                    ...
                    {/* Crypto Rows */}
                    {cryptoAssets.slice(0, 8).map((asset, index) => (
            ...
            <section className="bg-cb-gray-50 py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl sm:text-4xl font-bold text-cb-dark mb-4">
                            Create your cryptocurrency portfolio today
                        </h2>
                        <p className="text-lg text-cb-gray-500 max-w-2xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="bg-white rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300 border border-cb-gray-200 group"
                            >
                                <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-cb-blue group-hover:text-white transition-all duration-300">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-gradient-to-br from-blue-600 to-cb-blue rounded-3xl p-10 text-white relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold mb-3">Coinbase Wallet</h3>
                                <p className="text-white/80 mb-6 leading-relaxed">
                                    The self-custody wallet. Your keys, your crypto. Take control of your digital assets with the most trusted wallet.
                                </p>
                        ...
                        <div className="bg-gradient-to-br from-gray-900 to-cb-dark rounded-3xl p-10 text-white relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold mb-3">Coinbase Card</h3>
                                <p className="text-white/80 mb-6 leading-relaxed">
                                    Spend your crypto anywhere. Earn up to 4% back in crypto rewards when you spend with Coinbase Card.
                                </p>
            ...
            <section className="bg-cb-blue py-20">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-white/80 mb-10">
                        Join the 200M+ people who use Coinbase to buy, sell, and manage crypto.
                    </p>
